...
# 2. CONFIGURATION
# Path to Physics library
BASE_PATH = r"C:\UNT_DEBUGGING\dataset\converted_library\Physics"
TARGET_FOLDERS = ["7", "8", "9", "10", "11"]

# Output file
OUTPUT_FILE = os.path.join(os.getcwd(), "data", "physics_knowledge_graph.json")

CHUNK_SIZE_CHARS = 15000

# 3. PROMPT (Physics Context)
SYSTEM_PROMPT = """
You are an expert Physics Curriculum Developer for the Kazakhstan National Testing Center (UNT).
Your task is to analyze an educational Markdown file (in KAZAKH) and extract a Knowledge Graph.

RULES:
1. Identify KEY CONCEPTS (Physical Laws, Formulas, Definitions, Constants).
...
5. Use 'id' in English Snake Case (e.g., "newtons_second_law") for linking.
...
def main():
    ...
    print("🚀 Starting PHYSICS Extraction...")
    ...
    print(f"\n💾 Saving {len(all_data)} PHYSICS concepts...")
